...
function Get-AzADSpCredential {
    ...
    param(
        ...
        [Parameter(ParameterSetName='SPNParameterSet', Mandatory, HelpMessage = "The service principal name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Category('Body')]
        [System.String]
        ${ServicePrincipalName},

        [Parameter(ParameterSetName='DisplayNameParameterSet', Mandatory, HelpMessage = "Display name of the service principal.")]
        [Microsoft.Azure.PowerShell.Cmdlets.Resources.MSGraph.Category('Body')]
        [System.String]
        ${DisplayName},
    ...
    process {
        ...
        $sp = Get-AzADServicePrincipal @PSBoundParameters
        if ($sp.KeyCredentials) {
            $PSCmdlet.WriteObject($sp.KeyCredentials, $true)
        }
        if ($sp.PasswordCredentials) {
            $PSCmdlet.WriteObject($sp.PasswordCredentials, $true)
        }       
    }
}
...
# wUZ0G85OUJbQ/lz9Z2bfzNNAIqDhGqCCDYUwggYDMIID66ADAgECAhMzAAADri01
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAgm
# 5vlVz0XVM9KJtwpQNTbV2VzMgb96wdDEHL5t/MUvMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA5+Pqa2W4MX47L8ZGw0qJI38HF3wavCCQ680G
# ZOIiA5q4Ggp9XhQKxf+zRjWGVY4OmeUZ99X3RB8uBGyXAfUkWTqOCDiTNnDj4WNc
# Y0lBf2/50x8yModgWndqekec0mJQlhvzGd8pyxXvoPyDJ7mZz/fCMIO/tiRrxU6S
# h5wDM6hW6C+kYEXKwpFKLAEI65nJF8/tfR1NAyey6jzB5FXGr3VTbi7Opjf4CYzC
# SLxqOyK7s5YekZzN6DUp/ajwvMQPvpPiYXhtkRYnhecJV/4wi9caSMGguPV+Gi6F
# qItlnp00Og+hWV05xYRBBHzk3M/GBmrmPMMeFaYwaMN7EfO8Z6GCFywwghcoBgor
# BgEEAYI3AwMBMYIXGDCCFxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCB+CJbyWrJGQP2JyQj1Mlq8/bVnztrWDy5u
# 5+CvtWplZwIGZnMJKjdxGBMyMDI0MDcwNDA4MzA1Mi44NjVaMASAAgH0oIHYpIHV
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgdEBrGChG2IEaHIsdtoOg3t1ZwQLun3Vc2OMd
# gaxxwCQwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAriSpKEP0muMbBUETO
...
# 8rHRZ5Bte6ehoG8renJqHF5JMA0GCSqGSIb3DQEBCwUABIICALKN3107EH8TSK7F
# dWUfHpDJSerDAB4ETCJ/iH1HoHPjLS2LFk/52q5eNcoOsX5mzF9iVZdU4yjNzjYY
# r1WVwaF3Zh0VaIzXj+qlzxp9YxgQ2tATdbRtqzvZdaNpBm2+xaGvm/6M2ubhuyUG
# lRQtAf5kYJHz1yyUq0MO6rSeePIu61IMEstwD5aSKj/qsVTH5HbzQaaVJx0xj+XR
# VaU2dP2ZvZgJnWNZiX6gU5JhGc8gOKbgN+pHJ9cS6CdoQbWxQvNFmPaM+w5hTTuB
# zSI9pAj1ow0ilft2qpNy+zrzB9VTsnQKhEqvS9EVS4YaWyis98qEz8WV7eHBTACq
# 2eeBbySp+JIoxYL6x/t7aRh64AYtno1tl4YV6QcuWd1zDsPLUDKzW8sSAp94kv3Q
# bj2kErHLxBTE06HU9mDD3g/rWDS1CK11g/OOWpE0c3UMwuMOO4ZYfPm5QrJsrjey
# gJu/MLMtS/RNRcg/kRupR+kuGGldM/XGofJ829bW+bOmJZQlDmRa0PSDjeFMWNpr
# 9aMvkZciE/4pfngcXD0e1PlAwcT1vMqolrw0tKBTqH3eNKTELGOEHPfdWE6je4PE
# E7NfveL908uaZqdkxgQQOHA8Gs4+DDbWsSOACwTFMzJYzd0sr8So8fpNF+4i47VJ
# ExgKTcbTWxV758U1RNYMn+cSIblS
